...
namespace DVLD.Pop_Ups
{
    public partial class Add_Edit_Person : RoundedBaseForm
    {
        ...
        //        if (state == State.Add)
        //        {
        //            newPersonId = await _personController.AddPersonAsync(person);
        //            if (newPersonId == null)
        //            {
        //                MessageBox.Show("National number already exists or failed to add.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //                btn_save.Enabled = true;
        //                return;
        //            }
        ...
        //        else
        //        {
        //            isUpdated = await _personController.UpdatePersonInfoAsync(person);
        //            if (!isUpdated)
        //            {
